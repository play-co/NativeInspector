...
var WebSocketXhr = (function() {
	...
	WebSocketXhr.prototype._getChannel = function() {
		...
		console.log('get channel:', this._url);
	...
	WebSocketXhr.prototype._handleXhrResponseGetChannel = function(xhr) {
		...
		console.log('object.channel:', object.channel);
	...
	WebSocketXhr.prototype._handleXhrResponseGet = function(xhr) {
		...
		var self = this;
		setTimeout(function() { self._readLoop(); }, 1000);
	};
	...
	WebSocketXhr.prototype._getListeners = function(type) {
		...
		if (null === listeners) {
			throw new Error("invalid event listener type: '" + type + "'");
		}
		return listeners;
	};
	...
	WebSocketXhr.prototype._handleXhrResponseError = function(xhr) {
		...
		console.error(("error from XHR invocation: " + xhr.status + ": ") + xhr.statusText);
	};
